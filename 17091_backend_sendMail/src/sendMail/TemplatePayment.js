                      ...
                      <tr>
                        <td>
                          <div class="align-center">
                            ...
                            <!-- <h3>
                              <br>ยืนยันการชำระเงินค่าสมัครสอบกลุ่มวิชา
                            </h3>   -->
                            <h3>
                              <br>สำนักงานเลขาธิการคุรุสภาได้รับข้อมูลยืนยันการชำระเงินค่าสมัครสอบ กลุ่มวิชา
                              <br>ระบบกระดาษ ประจำปี พ.ศ. 2568 ของท่าน จากธนาคารแล้ว
                            </h3>  
                          </div>
                        <div >
                          <p style="text-indent: 24px">
                            ท่านสามารถดำเนินการตรวจสอบสถานะการสมัครสอบได้ที่เว็บไซต์
                            <a href="https://kspsubjects2568.thaijobjob.com/">https://kspsubjects2568.thaijobjob.com/</a> เมนู  <b style="color: #0277BD;">"ตรวจสถานะการสมัครสอบ"</b>
                          </p>
                        </div>
                        </td>
                      </tr> 
